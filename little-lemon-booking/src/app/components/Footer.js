...
const socialMediaLinks = [
    { name: "Facebook", link: "https://www.facebook.com/LittleLemonRestaurant" },
    { name: "Instagram", link: "https://www.instagram.com/LittleLemonRestaurant" },
    { name: "Twitter", link: "https://www.twitter.com/LittleLemonRestaurant" }
];
    ...
    return (
        <footer className="justify-center flex flex-row bg-llgreen text-white py-4">
            <div className="flex mx-20 items-center">
                <img src="/assets/Logo.svg" className="bg-white/75 rounded-4xl p-2"/>
            </div>
            <div className="mx-20">
            ...
            <div className="mx-20">
                ...
                <ul className="mt-5">
                    {socialMediaLinks.map((item) => (
                        <li key={item.name}>
                        <a href={item.link} className="text-white hover:text-llyellow" target="_blank" rel="noopener noreferrer">
                            {item.name}
                        </a>
                        </li>
                    ))}
