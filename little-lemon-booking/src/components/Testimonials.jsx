            ...
            <div className="container mx-auto text-black">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div className="bg-white p-4 rounded shadow">
                        ...
                        <img src={Testimonial1} alt="Customer 1" className="w-16 h-16 rounded-full mb-4"/>
                        {[...Array(5)].map((_, i) => (
                    ...
                    <div className="bg-white p-4 rounded shadow">
                        <span className="flex flex-row items-center">
                        <img src={Testimonial2} alt="Customer 2" className="w-16 h-16 rounded-full mb-4"/>
                        {[...Array(4)].map((_, i) => (
                            <FaStar key={i} className="text-yellow-500" />
                        ))}
                    ...
                    <div className="bg-white p-4 rounded shadow">
                        <span className="flex flex-row items-center">
                        <img src={Testimonial3} alt="Customer 3" className="w-16 h-16 rounded-full mb-4"/>
                        {[...Array(5)].map((_, i) => (
                            <FaStar key={i} className="text-yellow-500" />
                        ))}
                        </span>
